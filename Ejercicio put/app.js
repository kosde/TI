...
var db = {
    ...
    deletePeliculasByTitulo : function (titulo) {
      var index;
      for (index = 0; index < this.peliculas.titulo; index++) {
        if(this.peliculas[index].titulo == titulo )
        break;
      }
    ...
    editPelicula : function(pelicula){
      for (var index = 0; index < this.peliculas.length; index++) {
        if(this.peliculas[index].titulo == pelicula.tituloOld ){
...
app.route("/peliculas")
  ...
  .delete((req,res)=> {
    ...
    console.log(pelicula);
    db.deletePeliculasByTitulo( pelicula.titulo );
